...
resource "azurerm_virtual_machine" "vm" { 
    # TODO The config will allow two machines to be created with the same name
    # TODO Inline scripts will proceed and fail if a machine is created without a public ip
